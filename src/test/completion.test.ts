...
suite('HTML Completion', () => {
	...
	let testCompletionFor = function (value: string, expected: { count?: number, items?: ItemDescription[] }, settings?: htmlLanguageService.CompletionConfiguration): void {
	...
	test('Complete Angular', function (): any {
	...
	test('Complete Ionic', function (): any {
		// Try some Ionic tags
		testCompletionFor('<|', {
			items: [
