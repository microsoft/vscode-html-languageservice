...
export const HTML5_VALUE_MAP = {
	b: [{ name: 'true' }, { name: 'false' }],
	u: [{ name: 'true' }, { name: 'false' }, { name: 'undefined' }],
	o: [{ name: 'on' }, { name: 'off' }],
	y: [{ name: 'yes' }, { name: 'no' }],
	w: [{ name: 'soft' }, { name: 'hard' }],
	d: [{ name: 'ltr' }, { name: 'rtl' }, { name: 'auto' }],
	m: [{ name: 'GET' }, { name: 'POST' }, { name: 'dialog' }],
	fm: [{ name: 'GET' }, { name: 'POST' }],
	s: [{ name: 'row' }, { name: 'col' }, { name: 'rowgroup' }, { name: 'colgroup' }],
	t: [
		{ name: 'hidden' },
		{ name: 'text' },
		{ name: 'search' },
	...
	bt: [{ name: 'button' }, { name: 'submit' }, { name: 'reset' }, { name: 'menu' }],
	lt: [{ name: '1' }, { name: 'a' }, { name: 'A' }, { name: 'i' }, { name: 'I' }],
	mt: [{ name: 'context' }, { name: 'toolbar' }],
	mit: [{ name: 'command' }, { name: 'checkbox' }, { name: 'radio' }],
	et: [{ name: 'application/x-www-form-urlencoded' }, { name: 'multipart/form-data' }, { name: 'text/plain' }],
	tk: [
		{ name: 'subtitles' },
		{ name: 'captions' },
		{ name: 'descriptions' },
	...
	pl: [{ name: 'none' }, { name: 'metadata' }, { name: 'auto' }],
	sh: [{ name: 'circle' }, { name: 'default' }, { name: 'poly' }, { name: 'rect' }],
	xo: [{ name: 'anonymous' }, { name: 'use-credentials' }],
	sb: [
		{ name: 'allow-forms' },
		{ name: 'allow-modals' },
	...
	tristate: [{ name: 'true' }, { name: 'false' }, { name: 'mixed' }, { name: 'undefined' }],
	inputautocomplete: [
	...
	autocomplete: [{ name: 'inline' }, { name: 'list' }, { name: 'both' }, { name: 'none' }],
	current: [
		{ name: 'page' },
		{ name: 'step' },
		{ name: 'location' },
	...
	invalid: [{ name: 'grammar' }, { name: 'false' }, { name: 'spelling' }, { name: 'true' }],
	live: [{ name: 'off' }, { name: 'polite' }, { name: 'assertive' }],
	orientation: [{ name: 'vertical' }, { name: 'horizontal' }, { name: 'undefined' }],
	relevant: [
		{ name: 'additions' },
		{ name: 'removals' },
		{ name: 'text' },
	...
	sort: [{ name: 'ascending' }, { name: 'descending' }, { name: 'none' }, { name: 'other' }],
	roles: [
		{ name: 'alert' },
		{ name: 'alertdialog' },
		{ name: 'button' },
